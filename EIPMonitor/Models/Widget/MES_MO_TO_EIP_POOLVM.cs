...
namespace EIPMonitor.Model.Widget
{
    public class MES_MO_TO_EIP_POOLVM : ViewModelBase,IEquatable<MES_MO_TO_EIP_POOLVM>
    {
        ...
        public static MES_MO_TO_EIP_POOLVM GetDefaultInstance(UserStamp userStamp)
        {
            return new MES_MO_TO_EIP_POOLVM() { HAS_UPLOADED_FLAG = 0, IS_UPLOADABLE_TO_EIP = 0, UPLOAD_TO_OA_FLAG = 0, CREATED_DATE = DateTime.Now, CREATOR = $"{userStamp.EmployeeId} {userStamp.UserName}" };
        }
        ...
        public bool Equals(MES_MO_TO_EIP_POOLVM other)
        {
        ...
        {
            MES_MO_TO_EIP_POOLVM other = obj as MES_MO_TO_EIP_POOLVM;
