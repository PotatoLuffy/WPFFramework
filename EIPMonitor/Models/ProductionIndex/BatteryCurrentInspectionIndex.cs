...
{
    public class BatteryCurrentInspectionIndex: IPIScoreDetail
    {
        public BatteryCurrentInspectionIndex(string workOrder, IEnumerable<PP_TEST_BATCUR> totalList, IEnumerable<PP_TEST_BATCUR> passList)
        {
