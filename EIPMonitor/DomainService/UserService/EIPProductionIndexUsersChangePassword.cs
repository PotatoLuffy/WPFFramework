...
{
    public sealed class EIPProductionIndexUsersChangePassword
    {
        private readonly IUpdateCommand updateCommand;
        private readonly string searchSql;
        private readonly string updateSql;
        public EIPProductionIndexUsersChangePassword()
        {
        ...
        public async Task<EIPProductionIndexUsers> PasswordReset(EIPProductionIndexUsers eIPProductionIndexUsers)
        {
            ...
            if (dbEntry == null) throw new EntryNotFoundException("修改失败，未找到该账号。");
            if (dbEntry.Password != eIPProductionIndexUsers.Password) throw new EntryValidationException("修改失败，旧密码错误。");
